...
RUN mkdir -p src/rustarium && touch src/rustarium/__init__.py
...
# OCI Standard Labels
LABEL org.opencontainers.image.title="rustarium"
LABEL org.opencontainers.image.description="Production-ready Python application container"
LABEL org.opencontainers.image.licenses="Apache-2.0"
LABEL org.opencontainers.image.source="https://github.com/markurtz/rustarium"
