...
Welcome to `rustarium`! This section walks you through everything you need to go from zero to productive.
...
Install `rustarium` via pip, from source, or using Docker.
...
Your first 5 minutes with `rustarium`. Initialize, run a command,
