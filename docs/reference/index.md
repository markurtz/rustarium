...
The Reference section contains the complete technical documentation for rustarium — API classes and configuration options. This is the section to bookmark when you need to look something up.
...
[:octicons-arrow-right-24: Python API Reference](api/rustarium/)
...
`rustarium` can also be used programmatically in your own Python scripts:

```python
from rustarium import Settings, configure_logger, logger
from rustarium.logging import LoggingSettings
